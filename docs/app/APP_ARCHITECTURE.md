...
#### Content Types
1. **Exercises** (Free tier gets 3, Premium gets all)
   - Breathing
   - Golden Light
   - Counting
   - Self-Talk (Premium)
...
1. **In-app habits** (tracked automatically)
   - Breathing (count per day)
   - Golden Light (once per day)
   - Counting
   - etc.
...
*For implementation, reference this alongside convexGuidelines.md*
